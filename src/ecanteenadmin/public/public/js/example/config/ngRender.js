define(function (require) {
    ...
    function ngRender(NgAdminConfigurationProvider, UserAdminProvider) {
      ...
      var user = UserAdminProvider.$get();
    ...
    ngRender.$inject = ['NgAdminConfigurationProvider', 'UserAdminProvider'];
